...
Why is this important? Well, at the very least, it tells us that looking for a minimum with any of our $L^p$ norms won't be futile, since all norms are bounded below by zero! In particular, MSE is continuous and bounded below, so it has a global minimum. This will be good to know for the future when use MSE time and time again as a loss function.